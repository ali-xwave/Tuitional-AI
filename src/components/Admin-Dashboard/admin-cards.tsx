        ...
        <Grid container spacing={2}>
          <Grid item xs={12} lg={3}>
            <AdminCard
              ...
              hasPercentageChange={false} percentageChange={undefined} changeColor={undefined} percentageText={undefined} />
          </Grid>
          <Grid item xs={12} lg={3}>
            <AdminCard
              icon={<DescriptionIcon style={{ color: colors.textGray, fontSize: '7vh' }} />}
              ...
              changeColor={colors.scoreRed}
              percentageText='Than Last Week'
              hasPercentageChange={true} buttonText={undefined} buttonStyle={undefined} />
          </Grid>
          <Grid item xs={12} lg={3}>
            <AdminCard
              icon={<SportsEsportsIcon style={{ color: colors.textGray, fontSize: '7vh' }} />}
              title='Play Games'
              value='216'
              subText='Games Played this week'
              percentageChange='+24.6%'
              changeColor={colors.scoreGreen}
              percentageText='Than Last Week'
              hasPercentageChange={true} buttonText={undefined} buttonStyle={undefined} />
